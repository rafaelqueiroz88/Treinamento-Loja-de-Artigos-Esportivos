<?php
	...
	*/
	...
	// SEUS DADOS
	$dadosboleto["identificacao"] = "C&oacute;digo";
	$dadosboleto["cpf_cnpj"] = "391.128.188-95";
	$dadosboleto["endereco"] = "Coloque o endereço da sua empresa aqui";
	$dadosboleto["cidade_uf"] = "Cidade / Estado";
	$dadosboleto["cedente"] = "Coloque a Razão Social da sua empresa aqui";

	// NÃO ALTERAR!
	include("./Functions/boleto/include/funcoes_bb.php"); 
	include("./Functions/boleto/include/layout_bb.php");
?>
